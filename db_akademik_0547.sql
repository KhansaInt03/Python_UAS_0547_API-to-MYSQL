...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2022 at 02:50 PM
...
--
-- Table structure for table `tbl_students_0547`
--

CREATE TABLE `tbl_students_0547` (
  `id` int(100) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0547`
--

INSERT INTO `tbl_students_0547` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0547`
--
ALTER TABLE `tbl_students_0547`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_students_0547`
--
ALTER TABLE `tbl_students_0547`
